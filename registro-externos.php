...
<head>
    ...
    <title>Registro Profesionistas/Egresado</title>
...
<body>
    ...
    <section class="container form-section">
        <h2 class="text-center title-form">Registro para Público en General</h2>
        <!--Formulario para revisar registros en base de datos TECNM-->
        <form id="form-externos">
        <div class="row g-3">
            <div class="col-12">
                <hr>
                <label for="" class="form-label">Datos Personales</label>
                <hr>
            </div>
            <div class="col-md-6">
              <label for="rfc" class="form-label">RFC<span style="color:red">*</span></label>
              <input type="text" class="form-control" id="rfc" name="rfc" required style="text-transform: uppercase">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <label for="state" class="form-label">Estado<span style="color:red">*</span></label>
                  <select name="select_box" id="select_box" class="form-select" required>
            ...
            <div class="col-md-3">
                <label for="zip" class="form-label">Código Postal<span style="color:red">*</span></label>
                <input type="text" class="form-control" id="zip" name="zip" required>
            </div>
            <!--<div class="col-md-3">
              <label for="num_control" class="form-label">Teléfono de Casa</label>
              <input type="text" class="form-control" id="telefono" name="telefono">
            </div>-->
            <div class="col-md-3">
              <label for="num_control" class="form-label">Telefono Celular<span style="color:red">*</span></label>
            ...
            <div class="col-12">
                <hr>
                <label for="" class="form-label">Datos Laborales</label>
                <hr>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-6">
              <label for="empresa" class="form-label">Empresa/Institución a la que pertenece</label>
              <input type="text" class="form-control" id="empresa" name="empresa" required>
            </div>
            <div class="col-md-3">
              <label for="funcion" class="form-label">Función Laboral</label>
              <select id="funcion" name="funcion" class="form-select" required>
                    <option value="">Seleccione una opción</option>
            ...
            <div class="col-12">
              ...
              &nbsp;
              &nbsp;
              <button type="button" class="btn btn-primary btn-lg" onclick="registro()">Registrarme</button>
            </div>
        </form>
    </section>
...
<script>
    ...
    let select_box_element2 = document.querySelector('#genero');
    dselect(select_box_element2, {
      search: true
    });
    let select_box_element3 = document.querySelector('#sector');
    dselect(select_box_element3, {
      search: true
    });
    let select_box_element4 = document.querySelector('#funcion');
