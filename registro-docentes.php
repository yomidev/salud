...
<body>
    ...
    <section class="container form-section">
        <h2 class="text-center title-form">Registro para Docentes TECNM</h2>
        <form id="form-docentes">
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    &nbsp;
                    &nbsp;
                    <button type="button" class="btn btn-primary btn-lg" onclick="registroDocentes()">Registrarme</button>
                </div>
            </div>
        </form>
    </section>
